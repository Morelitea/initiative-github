...
export const getPullRequest: Read = {
  declaration: {
    ...
    returns: [
      ...
      STATE_OUT,
      value("merged", "bool", "Merged", "Gemergt", "Fusionada", "Fusionnée"),
      value("draft", "bool", "Draft", "Entwurf", "Borrador", "Brouillon"),
      URL_OUT,
      AUTHOR_OUT,
      LABELS_OUT,
      ASSIGNEES_OUT,
      MILESTONE_OUT,
      COMMENTS_OUT,
      value("head_ref", "string", "From branch", "Von Branch", "Desde la rama", "Depuis la branche"),
      value("base_ref", "string", "Into branch", "Nach Branch", "Hacia la rama", "Vers la branche"),
      value("commits", "int", "Commits", "Commits", "Commits", "Commits"),
      value(
        "changed_files",
        "int",
        "Files changed",
      ...
      UPDATED_OUT,
      CLOSED_OUT,
      value("merged_at", "string", "Merged", "Gemergt am", "Fusionada el", "Fusionnée le"),
      UNAVAILABLE,
    ],
    requires: { all_of: ["workspace", "account"] },
  },
